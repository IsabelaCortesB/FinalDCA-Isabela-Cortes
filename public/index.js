...
class AppContainer extends HTMLElement {
    ...
    connectedCallback() {
        ...
        register === null || register === void 0 ? void 0 : register.addEventListener("login-success", () => {
            var _a;
            ...
            login === null || login === void 0 ? void 0 : login.addEventListener("login-success", () => {
                ...
                this.screen = Screens.home;
                this.render();
                const PostForm = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('new-post');
                PostForm === null || PostForm === void 0 ? void 0 : PostForm.addEventListener('added-post', () => {
                    this.screen = Screens.home;
                    this.render();
                });
            });
